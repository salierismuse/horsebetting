...
if (existingHorses.count === 0) {
  ...
  insertHorse.run('Jangles', JSON.stringify({ start: 0.2, end: 2, luck: 0.3, rain: 1.0, sun: 1.0 }), 8);
  insertHorse.run('Echo', JSON.stringify({ start: 1.3, end: 1.0, luck: 0.1, rain: 1.5, sun: 0.8 }), 10);
  insertHorse.run('Blaze', JSON.stringify({ start: 2.0, end: 0.3, luck: 0.1, rain: 0.5, sun: 1.5 }), 12);
